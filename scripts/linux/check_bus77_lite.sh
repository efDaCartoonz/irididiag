...
# Standalone Bus77 Lite cloud diagnostic.
# Usage: sh check_bus77_lite.sh
...
WORK_DIR="$(mktemp -d "${TMPDIR:-/tmp}/bus77-lite.XXXXXX" 2>/dev/null)"
if [ -z "$WORK_DIR" ] || [ ! -d "$WORK_DIR" ]; then
  WORK_DIR="${TMPDIR:-/tmp}/bus77-lite.$$"
...
probe_resource bus77-lite "Облако Bus77 Lite" "https://bus77lite.ru.iridi.com/" "84.201.152.245" yes
probe_resource iphub-lite "Облако IP-Hub Lite" "https://iphub.ru.iridi.com/" "51.250.30.171" yes
