...
# Standalone i3 KNX cloud diagnostic.
# Usage: sh check_i3knx.sh
...
probe_resource auth-eu "Авторизация EU" "https://auth.eu.iridi.com/" "84.201.152.245" yes
probe_resource proxy-auth-eu "Прокси авторизации EU" "https://proxy.auth.eu.iridi.com/" "72.56.78.171" yes
probe_resource proxy-auth-cloud "Прокси авторизации Cloud" "https://proxy.auth.eu.iridi.cloud/" "94.131.83.102" yes
probe_resource i3knx-eu "Облако i3 KNX EU" "https://i3knx.eu.iridi.com/" "95.216.162.71" yes
probe_resource proxy-i3knx-eu "Прокси i3 KNX EU" "https://proxy.i3knx.eu.iridi.com/" "147.45.238.146" yes
probe_resource proxy-knx-cloud "Прокси KNX Cloud" "https://proxy.knx.eu.iridi.cloud/" "94.131.87.121" yes
probe_resource proxy-s3-eu "Прокси хранилища EU" "https://proxy.s3.eu.iridi.com/" "72.56.68.146" yes
probe_resource ping "Контрольный ресурс" "https://ping.iridiummobile.net/" "52.222.136.36" yes
probe_resource s3-eu "Хранилище проектов EU" "https://s3.eu.iridi.com/" "95.217.164.135" yes
check_gate
